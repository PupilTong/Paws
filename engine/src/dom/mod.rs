...
3. Assumptions:
   ...
   - **Simplification**: We strip full HTML5 parsing and legacy CSS handling out, focusing strictly on programmatically generated nodes, cutting down on parser complexity and memory footprint.
